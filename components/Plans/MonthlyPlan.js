...
const MonthlyPlan = () => {
  return (
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-10 mt-10 capitalize">
      <div className="card-border bg-white dark:bg-[#151515] price_card p-8 shadow-lg rounded-xl text-left text-fontclr">
        ...
        <button className="bg-gradient-to-t from-orange via-[#ff7e62] to-[#ff5f59] dark:text-[#151515] text-white font-semibold text-lg px-10 py-3 rounded-xl mt-3">
          Get Started
        </button>
      </div>

      <div className="card-border price_card p-8 bg-white dark:bg-[#151515] shadow-lg  rounded-xl text-left text-fontclr">
        <div>
        ...
        <button className="bg-gradient-to-t from-orange dark:text-[#151515] via-[#ff7e62] to-[#ff5f59] text-white font-semibold text-lg px-10 py-3 rounded-xl mt-3">
          Get Started
        </button>
      </div>
