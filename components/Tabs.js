                ...
                <div className="px-4 py-5 flex-auto">
                  <div className="tab-content tab-space">
                    ...
                    >
                      <div className="flex flex-col lg:flex-row ">
                        <div className="self-center py-2">
                          <p className="text-xl text-[#3742fa] ">Self Help</p>
                    ...
                    >
                      <div className="flex flex-col lg:flex-row ">
                        <div className="self-center py-2">
                          <p className="text-xl text-[#3742fa]">Flows</p>
                    ...
                    >
                      <div className="flex flex-col lg:flex-row ">
                        <div className="self-center py-2">
                          <p className="text-xl text-[#3742fa]">Pop-ups</p>
                    ...
                    >
                      <div className="flex flex-col lg:flex-row ">
                        <div className="self-center py-2">
                          <p className="text-xl text-[#3742fa] ">CheckList</p>
                    ...
                    >
                      <div className="flex flex-col lg:flex-row ">
                        <div className="self-center py-2">
                          <p className="text-xl text-[#3742fa] ">
                            Announcement
                          </p>
                    ...
                    >
                      <div className="flex flex-col lg:flex-row ">
                        <div className="self-center py-2">
                          <p className="text-xl text-[#3742fa] ">FeedBack</p>
