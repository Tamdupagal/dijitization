export default function ProgramDetails() {
  const features = [
    {
      title: "Duration : 10 hours",
      desc: "Mode : Digital Adoption Platform",
    },
    {
      title: "Premium Plan: $20/monthly",
      desc: "Access to Chatgpt tools and features on a monthly basis. Perfect for those who want to explore and use these tools occasionally.",
    },
    {
      title: "Unlimited Plan: $100/monthly",
      desc: "All access to GENAI tools and features, 24/7. Ideal for power users and those who want to maximize their AI capabilities.",
    },
  ];
  ...
  return (
    <section className="py-14 cta-sec">
      <div className="max-w-screen-xl mx-auto px-4 text-gray-600 md:px-8">
        ...
        <div className="mt-12">
          <p className="text-gray py-3 font-bold">TUITION FEES</p>
