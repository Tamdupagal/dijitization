...
const Banner = () => {
  return (
    <div className="bg-[#f4f7f2] text-center pt-32 px-6 lg:px-20 pb-36 dark:bg-[#0a1424] dark:text-white">
      <div className="flex flex-col pt-10 items-center justify-between">
        ...
        <div className="">
          <button className="  py-5 px-8 font-bold bg-[#2b2e4a]  text-white rounded-full mt-12  hover:bg-logotext hover:text-white ">
